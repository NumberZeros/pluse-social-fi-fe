    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      ...
      <div className="px-6 -mt-16">
        <div className="flex justify-between items-start mb-6">
          <div className="w-32 h-32 rounded-full bg-surface-2 border-4 border-background animate-pulse" />
          <div className="h-10 w-32 bg-surface-2 rounded-full animate-pulse" />
        </div>
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex gap-4 mt-4">
          <div className="h-10 flex-1 bg-surface-2 rounded animate-pulse" />
