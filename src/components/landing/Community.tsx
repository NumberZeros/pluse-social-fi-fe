...
export function Community() {
  ...
  return (
    <section className="relative z-10 py-20 px-6 max-w-[1400px] mx-auto border-t border-border">
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-h2 font-display mb-8">
            Join early on{' '}
        ...
        <div className="relative">
          <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full blur-3xl opacity-30" />
          <div className="relative bg-surface-2 border border-border rounded-3xl p-8 backdrop-blur-xl">
